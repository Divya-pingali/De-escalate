Shader "QuestCameraKit/CameraMapping/StereoPassthroughFrostedGlassTransparent"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "StereoPassthroughFrostedGlassTransparent"
            Cull Off
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                return half4(frosted, finalAlpha);
            }
            ENDHLSL
        }
    }
