Shader "QuestCameraKit/CameraMapping/StereoPassthroughBlockTransparent"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "StereoPassthroughBlockTransparent"
            Cull Off
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                float finalAlpha = _BlockStrength * _BlockColor.a * cameraEdgeFade * quadFade;

                return half4(_BlockColor.rgb, finalAlpha);
            }
